        ...
        try {
            ...
            if (!empty($this->material)) {
                foreach ($this->material as $fila) {
                   ...
                   $orden->materiales()->attach($fila['material_id'], ['cantidad' => $fila['cantidad'], 'serializado_id' => $fila['serializado_id']]);


                    if (!empty($fila['serializado_id'])) {

                        Serializado::where('id', $fila['serializado_id'])
                            ->where('fecha', $data['fecha']) // Segunda condición
                            ->update([
